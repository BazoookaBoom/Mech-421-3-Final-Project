...
// 			- [ ] Count to position accuracy
// 		- [ ] Solenoid Control
// 			- [ ] Driver output verification
// 			- [ ] Power modulation ability
// 		- [ ] Servo Accuracy Position
// 			- [ ] Servo
// 		- [ ] Limit Switch Stop Gantry
...
// // Limit Switches
// const int limRight = 12; //NC setup with connection to VCC
// const int limLeft = 13;  //NC setup with connection to VCC
...
// const int stepPerRotation = 200 * 5 *2 / 11; //Steps needed for a full rotation, will be used to calculate steps needed for a given position
...
// bool At_Left_Limit = false;
// bool At_Right_Limit = false;
...
// long slewPulse = 1522; //Start at center
// long targetPulse = 1522;
// int slewAngle = 0;
...
// void stepperHome() {
// 	//Move the gantry until the right limit switch is hit, then set currentStep to 0
// 	while (digitalRead(limRight) == HIGH) { //Assuming NC limit switch
// 		stepDir = 0; //Move right
// 		Stepper_Homing = true;
// 		stepperMove();
// 		if(millis() - prevSendTime >= SEND_INTERVAL) {
...
// 	unsigned long angle = constrain(slewAngle, 0, 270);
...
// 	analogWrite(solenoidPin, 255);  // 0–255 = 0–100% duty cycle
